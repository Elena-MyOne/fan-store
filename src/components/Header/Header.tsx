  ...
  return (
    <header className="header py-4 border">
      <div className="body flex justify-between container m-auto items-center">
        <Link to={ROUTER_PATH.HOME} className="logo ">
          <img className={style.headerLogoImage} src="/assets/images/logo/logo.png" alt="logo" />
        </Link>
        <div className="flex gap-10 items-center">
          <Link
            to={ROUTER_PATH.CART}
            className="cart flex items-center bg-orange-500 px-6 py-3 rounded-3xl font-bold text-white hover:bg-orange-600 duration-300"
          >
