...
const ProductItem = (props: ProductItemProps) => {
  ...
  const descriptionButtonStyle = description
    ? 'px-6 py-1 block text-white bg-orange-500 hover:bg-orange-600 duration-300 rounded-3xl'
    : 'px-6 py-1 block text-white bg-gray-700 hover:bg-gray-900 duration-300 rounded-3xl';

  const buttonCartStyle = cartAdd ? activeButtonsStyle : buttonsStyle;

  return (
    <div className="flex flex-col items-center border border-gray-300 pt-10 pb-3 px-4 rounded mb-2 hover:shadow-lg duration-300 relative">
      <div className="buttons absolute top-3 left-3 flex gap-4">
