...
const ShoppingCart = () => {
  const { items, itemsCount, totalPrice, totalSale } = useSelector(
      ...
      <div className="divide-y">
        <div className="top flex justify-between items-center gap-10 p-2">
          ...
          <button
            ...
            className="clear flex justify-between items-center gap-2 text-gray-400 hover:text-orange-500 duration-300"
          >
        ...
        <div className="summary p-2 flex justify-between items-center gap-10">
          <div className="amount">
            Items: <span className="number font-bold">{itemsCount}</span>
          </div>
          <div className="sum">
