...
const CartItem = (props: CartData) => {
  ...
  return (
    <div>
      <h3 className="name font-semibold my-2 text-center">{props.name}</h3>

      <div className="item flex flex-col md:flex-row justify-between items-center gap-6 px-2 py-3 relative">
        <div className="content flex flex-col md:flex-row justify-center items-center gap-4">
        ...
        <div className="buttons flex flex justify-center items-center gap-4">
