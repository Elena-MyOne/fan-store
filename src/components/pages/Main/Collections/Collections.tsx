...
import { FACULTY, ROUTER_PATH } from '../../../../models/enums';
  ...
  return (
    <section className="py-10">
      ...
      <ul className="items grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 items-center justify-between text-center">
        <li
          className={`${style.one} h-60 text-white font-fjalla hover:text-orange-400 duration-300 text-xl rounded-xl cursor-pointer`}
        ...
        <li
          className={`${style.two} h-60 text-white font-fjalla hover:text-orange-400 duration-300 text-xl rounded-xl cursor-pointer`}
        ...
        <li
          className={`${style.three} h-60 text-white font-fjalla hover:text-orange-400 duration-300 text-xl rounded-xl cursor-pointer`}
        ...
        <li
          className={`${style.four} h-60 text-white font-fjalla hover:text-orange-400 duration-300 text-xl rounded-xl cursor-pointer`}
